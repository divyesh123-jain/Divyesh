  ...
  return (
    <div className=' min-h-screen bg-gradient-to-r from-blue-300 to-white'>
      <motion.div    className='md:mx-8  pt-12 grid  grid-cols-1 sm:grid-cols-1 lg:grid-cols-3 gap-28'>
        <motion.div className='  sm:mx-4 bg-gradient-to-r from-blue-300 to-white flex flex-col dark-shadows transitionall hover:shadow-[6px_6px_0px_0px_rgba(0,0,0,0.9)] shadow-[5px_5px_0px_0px_rgba(0,0,0,0.1)] cursor-pointer rounded-xl justify-center items-center h-[360px] w-[390px] bg-blue-100'>
        ...
        <motion.div  className='bg-gradient-to-r from-blue-300 to-white flex flex-col dark-shadows transitionall hover:shadow-[6px_6px_0px_0px_rgba(0,0,0,0.9)] shadow-[5px_5px_0px_0px_rgba(0,0,0,0.1)] cursor-pointer rounded-xl justify-center items-center h-[360px] w-[390px] bg-blue-100'>
            <motion.h2 className='text-5xl  text-center pt-7'  >
